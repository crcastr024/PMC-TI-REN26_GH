...
function renderHomeTecnico() {
  ...
  function nextAction(u) {
    ...
    const NEXT = {
      ...
      'Pendiente devolución equipo anterior':'Recoger el equipo anterior del usuario',
      'En tránsito equipo anterior':      'Confirmar recepción en bodega',
      'Equipo anterior recibido':         'Registrar en bodega y solicitar validación de cierre',
